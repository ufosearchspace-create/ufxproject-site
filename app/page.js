...
export default function Home() {
  return (
    <main
      className="min-h-screen flex flex-col items-center justify-center text-center p-10 bg-cover bg-center"
    ...
    >
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-4">
        <a
          href="https://pump.fun" // 👉 zamijeni s pravim Pump.fun linkom
          target="_blank"
        ...
        <a
          href="https://x.com/ufxproject" // 👉 zamijeni s točnim X (Twitter) linkom
          target="_blank"
